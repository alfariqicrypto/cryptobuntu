...
COIN_TGZ='https://github.com/CRYPTOBUNTU/Buntu/releases/download/1.0/buntud1804.tar.gz'
COIN_BOOTSTRAP='https://github.com/CRYPTOBUNTU/Buntu/releases/download/3.0/bootstrap.tar.gz'
