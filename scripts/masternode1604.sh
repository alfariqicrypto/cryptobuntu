...
COIN_REPO='https://github.com/CRYPTOBUNTU/Buntu.git'
COIN_TGZ='https://github.com/CRYPTOBUNTU/Buntu/releases/download/1.0/buntud1604.tar.gz'
COIN_BOOTSTRAP='https://github.com/CRYPTOBUNTU/Buntu/releases/download/1.0/bootstrap.tar.gz'
