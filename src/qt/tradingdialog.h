...
private slots:
    ...
    QString BuyBNTU(QString OrderType, double Quantity, double Rate);
    QString SellBNTU(QString OrderType, double Quantity, double Rate);
